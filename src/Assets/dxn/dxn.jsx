...
import './dxn.css'; // Ensure you have this to apply the classes

const Logo = ({ theme }) => {
  return (
    <div className={`iconContainer ${theme}`}>
      <svg
        id="Layer_1"
      ...
      >
        <defs>
          <style>
            {`
              ...
              .cls-2 { fill: #fff; }
              .light .cls-2 { fill: #000; }
              .light .cls-1 { fill: #fff; }
              .dark .cls-2, .dim .cls-2 { fill: #fff; }
              .dark .cls-1, .dim .cls-1 { fill: inherit; }
            `}
          </style>
        </defs>
        <rect
        ...
        />
        <polygon className="cls-1" points="906.78 762.51 921.16 762.51 891.4 720.19 886.79 721.55 906.78 762.51" />
        <polyline className="cls-1" points="794.27 513.71 822.94 515.43 846.6 566.25 810.38 554.73 794.27 516.4" />
        <polygon className="cls-1" points="962.73 762.51 962.73 513 925.5 513 926.16 677.52 936.88 762.51 962.73 762.51" />
        <circle className="cls-1" cx="406.18" cy="647.25" r="18.63" />
      </svg>
    </div>
  );
};
