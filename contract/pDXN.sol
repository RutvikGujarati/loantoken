 ...
 */
contract system_state_sc_Autovaults_V1_2 is
    Ownable(msg.sender),
    ReentrancyGuard
{
    ...
    function getAddresses() public view returns (address PDXN, address DavPLS) {
        return (address(pDXN), address(DAVPLS));
    }
    ...
    function deposit(uint256 value) public onlyDepositer {
        ...
        require(
            pDXN.transferFrom(msg.sender, address(this), value),
    ...
    function contractTokenBalance() public view returns (uint256) {
        return pDXN.balanceOf(address(this));
    }
    ...
    function claimAllReward() public nonReentrant {
        ...
        require(
            pDXN.transfer(user, allRewardAmount),
