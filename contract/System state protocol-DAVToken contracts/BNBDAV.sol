...
contract DAVBNB is ERC20, Ownable, ReentrancyGuard {
    // -> Max Supply of bFENIX, bDXN and BNB
    ...
    constructor(
        ...
        bFENIX_TOKEN_ADDRESS = BFENIX_TOKEN_ADDRESS;
