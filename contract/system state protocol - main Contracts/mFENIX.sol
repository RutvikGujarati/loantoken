 ...
 */
contract system_state_sc_Autovaults_V1_2_mFENIX is
    Ownable(msg.sender),
    ReentrancyGuard
{
    using SafeMath for uint256;

    IERC20 public mFENIX;
    ...
    function getAddresses() public view returns (address PDXN, address DavPLS) {
        return (address(mFENIX), address(DavMatic));
    }
    ...
    function deposit(uint256 value) public onlyDepositer {
        ...
        require(
            mFENIX.transferFrom(msg.sender, address(this), value),
    ...
    function contractTokenBalance() public view returns (uint256) {
        return mFENIX.balanceOf(address(this));
    }
    ...
    function claimAllReward() public nonReentrant {
        ...
        require(
            mFENIX.transfer(user, allRewardAmount),
