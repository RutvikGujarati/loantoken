 ...
 */
contract system_state_sc_Autovaults_V1_2_mXEN is
    Ownable(msg.sender),
    ReentrancyGuard
{
    ...
    function getAddresses() public view returns (address PDXN, address DavPLS) {
        return (address(mXEN), address(DavMatic));
    }
    ...
    function deposit(uint256 value) public onlyDepositer {
        ...
        require(
            mXEN.transferFrom(msg.sender, address(this), value),
    ...
    function contractTokenBalance() public view returns (uint256) {
        return mXEN.balanceOf(address(this));
    }
    ...
    function claimAllReward() public nonReentrant {
        ...
        require(
            mXEN.transfer(user, allRewardAmount),
