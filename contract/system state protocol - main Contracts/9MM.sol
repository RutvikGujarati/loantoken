    ...
    ReentrancyGuard
{
    ...
    constructor(
        ...
        NINE_MM = IERC20(_NINE_MMAddress);
    ...
    function getAddresses() public view returns (address PDXN, address DavPLS) {
        return (address(NINE_MM), address(davTrade));
    }
    ...
    function deposit(uint256 value) public onlyDepositer {
        ...
        require(
            NINE_MM.transferFrom(msg.sender, address(this), value),
    ...
    function contractTokenBalance() public view returns (uint256) {
        return NINE_MM.balanceOf(address(this));
    }
    ...
    function claimAllReward() public nonReentrant {
        ...
        require(
            NINE_MM.transfer(user, allRewardAmount),
