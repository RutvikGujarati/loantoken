    ...
    ReentrancyGuard
{
    ...
    event AddressesUpdated(address indexed PTS, address indexed davpls);

    /**
     * @dev Initializes the contract with the specified token addresses and depositer address.
     * @param _PTSAddress The address of the XEN token contract.
    ...
    constructor(
        ...
        require(_PTSAddress != address(0), "Invalid XEN token address");
    ...
    function getAddresses() public view returns (address PDXN, address DavPLS) {
        return (address(PTS), address(davTrade));
    }
    ...
    function deposit(uint256 value) public onlyDepositer {
        ...
        require(
            PTS.transferFrom(msg.sender, address(this), value),
    ...
    function contractTokenBalance() public view returns (uint256) {
        return PTS.balanceOf(address(this));
    }
    ...
    function claimAllReward() public nonReentrant {
        ...
        require(
            PTS.transfer(user, allRewardAmount),
